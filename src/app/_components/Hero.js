...
const Hero = () => {
  return (
    ...
    Looking for an experienced MERN Stack developer to bring your web project to life? With over <span className="font-bold">5</span> years of expertise in full-stack development, we specialize in building dynamic, responsive, and scalable web applications that deliver exceptional user experiences and meet the demands of modern businesses.
</p>
