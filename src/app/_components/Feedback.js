...
const Feedback = ({ img, projectName, madeFor, feedback, client, url, ind }) => {
  return (
    ...
    >
      ...
      {/* Text Column */}
      <div
        className={`lg:flex-grow lg:w-1/2 ${ind  % 2 === 0 ? "lg:pl-24 md:pl-16" : "lg:pr-24 md:pr-16"} flex flex-col md:items-start  items-center text-justify`}
      >
        <h1 className="title-font sm:text-2xl text-3xl font-semibold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-300">
          {projectName}
        </h1>
