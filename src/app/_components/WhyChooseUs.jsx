  ...
  return (
    <div className="relative flex flex-col bg-muted dark:bg-transparent  items-center justify-center h-auto pb-12 ">
      ...
      <div className="relative z-10 text-center px-10 pb-12 ">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-gray-600 to-gray-900 dark:from-gray-200 dark:to-gray-600 py-4">
          Why Choose Us?
        </h1>
